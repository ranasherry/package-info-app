...
class ZongSMS extends GetView<ZongCTL> {
  const ZongSMS({super.key});
        ...
        child: Center(
          child: Column(
            children: [
              ...
              Obx(
                () => controller.ZongSMSList.length != 0
                    ? Obx(
                        () => Expanded(
                          child: ListView.builder(
                              // physics: NeverScrollableScrollPhysics(),
                              // shrinkWrap: true,
                              itemCount: controller.ZongSMSList.length,
                              itemBuilder: (context, index) {
                                return zongSMSoffer(index);
                              }),
                        ),
                      )
                    : Column(
  ...
  Container zongSMSoffer(int index) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            "${controller.ZongSMSList[index].bundle}",
            style: TextStyle(
              ...
              children: [
                RichText(
                  text: TextSpan(
                      ...
                      children: [
                        TextSpan(
                            text: "${controller.ZongSMSList[index].validity}",
                            style: TextStyle(
                                fontWeight: FontWeight.bold,
                ...
                RichText(
                    text: TextSpan(
                        ...
                        children: [
                      TextSpan(
                          text: "${controller.ZongSMSList[index].rs}/-",
                          style: TextStyle(
              ...
              Column(
                children: [
                  ...
                  Container(
                      ...
                      child: Center(
                          child: Text(
                        "${controller.ZongSMSList[index].onnet}",
                        style: TextStyle(color: Colors.white),
                      ))),
                  Text(
                    "Minutes",
              ...
              Column(
                children: [
                  ...
                  Container(
                      ...
                      child: Center(
                          child: Text(
                        "${controller.ZongSMSList[index].offnet}",
                        style: TextStyle(color: Colors.white),
                      ))),
                  Text(
                    "Minutes",
              ...
              Column(
                children: [
                  ...
                  Container(
                      ...
                      child: Center(
                          child: Text(
                        "${controller.ZongSMSList[index].sms}",
                        style: TextStyle(color: Colors.white),
                      ))),
                  Text(
                    "Messages",
              ...
              Column(
                children: [
                  ...
                  Container(
                      ...
                      child: Center(
                          child: Text(
                        "${controller.ZongSMSList[index].internet}",
                        style: TextStyle(color: Colors.white),
                      ))),
                  Text(
                    "Mbs",
