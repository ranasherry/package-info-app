...
class WaridInternet extends GetView<WaridCTL> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Warid Internet Offer"),
        ...
        child: Center(
          child: SingleChildScrollView(
            child: Column(
              children: [
                Obx(
                  () => controller.waridInternetList.length != 0
                      ? Obx(
                          () => ListView.builder(
                              physics: NeverScrollableScrollPhysics(),
                              shrinkWrap: true,
                              itemCount: controller.waridInternetList.length,
                              itemBuilder: (context, index) {
                                return waridinternet(index);
                              }),
                        )
                      : Column(
                          children: [
  ...
  Container waridinternet(int index) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            "${controller.waridInternetList[index].bundle}",
            style: TextStyle(
              ...
              children: [
                RichText(
                  text: TextSpan(
                      ...
                      children: [
                        TextSpan(
                            text:
                                "${controller.waridInternetList[index].validity}",
                            style: TextStyle(
                                fontWeight: FontWeight.bold,
                ...
                RichText(
                    text: TextSpan(
                        ...
                        children: [
                      TextSpan(
                          text: "${controller.waridInternetList[index].rs}/-",
                          style: TextStyle(
              ...
              Column(
                children: [
                  ...
                  Container(
                      ...
                      child: Center(
                          child: Text(
                        "${controller.waridInternetList[index].onnet}",
                        style: TextStyle(color: Colors.white),
                      ))),
                  Text(
                    "Minutes",
              ...
              Column(
                children: [
                  ...
                  Container(
                      ...
                      child: Center(
                          child: Text(
                        "${controller.waridInternetList[index].offnet}",
                        style: TextStyle(color: Colors.white),
                      ))),
                  Text(
                    "Minutes",
              ...
              Column(
                children: [
                  ...
                  Container(
                      ...
                      child: Center(
                          child: Text(
                        "${controller.waridInternetList[index].sms}",
                        style: TextStyle(color: Colors.white),
                      ))),
                  Text(
                    "Messages",
              ...
              Column(
                children: [
                  ...
                  Container(
                      ...
                      child: Center(
                          child: Text(
                        "${controller.waridInternetList[index].internet}",
                        style: TextStyle(color: Colors.white),
                      ))),
                  Text(
                    "Mbs",
          ...
          GestureDetector(
            onTap: () {
              controller.currentPackage.value =
                  controller.waridInternetList[index];
